...
<div class="nk-content-inner">
    <div class="nk-content-body">
        ...
        <div class="section-header animate-in" style="animation-delay: 0.5s;">
            ...
            <a href="{{ route('admin.template') }}" class="section-link">
                <span>View all</span>
        ...
        <div class="templates-grid">
            ...
            <a href="{{ route('details.template', $template->id) }}" class="template-card animate-in" style="animation-delay: {{ 0.6 + ($index * 0.1) }}s;">
...
function updateGreeting() {
    ...
    if (hour < 12) {
        greetingEl.textContent = 'Good morning, Admin! Let’s start creating impactful academic templates today.';
    } else if (hour < 18) {
        greetingEl.textContent = 'Good afternoon, Admin! Keep your academic templates organized.';
    } else {
        greetingEl.textContent = 'Good evening, Admin! Keep building meaningful academic content.';
    }
}
