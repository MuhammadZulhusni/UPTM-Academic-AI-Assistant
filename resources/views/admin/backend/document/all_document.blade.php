...
<div class="nk-content-inner">
    <div class="nk-content-body">
        ...
        </div><div class="d-flex align-items-center justify-content-between border-bottom border-light mt-5 mb-4 pb-2">
            <h5>All Document</h5>
        </div>
        ...
        <div class="card">
            <table class="table table-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="tb-col">
                            <div class="caption-text">{{ $key + 1 }} <div class="d-sm-none dot bg-success"></div></div>
                        </td>
                        ...
                        <td class="tb-col tb-col-sm">
                            <a href="{{ route('content.generate', $item->id) }}" class="btn btn-success btn-sm">Edit</a>  
                            <a href="{{ route('content.generate', $item->id) }}" class="btn btn-danger btn-sm" id="delete">Delete</a>          
                        </td>
                    </tr>
                    @endforeach
                </tbody>
