...
<div class="nk-content-inner">
    <div class="nk-content-body">
        ...
        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between border-bottom border-lighot-3 mt-md-5 mb-4 pb-2 gap-3">
                                ...
                                <tr class="document-row">
                                    ...
                                    <td class="tb-col">
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <a href="{{ route('superadmin.edit.document', $item->id) }}" 
                                            ...
                                            <button type="button" 
                                                    ...
                                                    data-document-id="{{ $item->id }}"
                                                    data-delete-url="{{ route('superadmin.delete.document', $item->id) }}"
