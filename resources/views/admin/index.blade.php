    ...
    <div class="nk-content-body">
        ...
        <div class="nk-block-head">
            <div class="nk-block-head-between">
                ...
                <div class="nk-block-head-content">
                    <a href="#" class="link">Explore All</a>
                </div>
            </div>
        </div><!-- .nk-block-head -->
        <div class="nk-block">
                ...
                <div class="col-sm-6 col-xxl-3">
                    <div class="card card-full">
                        <div class="card-body">
                            ...
                            <h5 class="fs-4 fw-medium">Ideas</h5>
                ...
                <div class="col-sm-6 col-xxl-3">
                    <div class="card card-full">
                        <div class="card-body">
                            ...
                            <h5 class="fs-4 fw-medium">Posts</h5>
                ...
                <div class="col-sm-6 col-xxl-3">
                    <div class="card card-full">
                        <div class="card-body">
                            ...
                            <h5 class="fs-4 fw-medium">Tags Generator</h5>
        ...
        <div class="nk-block"></div><!-- .nk-block -->
    </div>
</div>
