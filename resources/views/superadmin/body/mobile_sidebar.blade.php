            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav ms-2">
                    <li class="dropdown d-inline-flex">
                        <a class="d-inline-flex" href="{{ route('superadmin.profile') }}">
                            <div class="media media-md media-circle media-middle text-bg-primary" 
                                ...
                                <img src="{{ (!empty($profileData->photo)) ? url('upload/superadmin_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" 
                                    alt="Profile Image" 
